...
public class PeekViewFB extends AppCompatActivity {
    ...
    private String url, appDirectoryName, mCameraPhotoPath;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new FloatingWebView() {
                ...
                try {
                    ...
                    if(url.contains("jpg")) {
                        if (Downloader.isImageFile(url) && hasStoragePermission()) {
                            Downloader.downloadFile(PeekViewFB.this, url, Downloader.getFileName(url));
                            finish();
                            return true;
                        }
            ...
            public void onPageStarted(WebView view, String url,  Bitmap favicon) {
                ...
                try {
                    ThemeUtils.backgoundColorStyle(PeekViewFB.this, view);
            ...
            public void onLoadResource(WebView view, String url) {
                ...
                try {
                    if (themePusher < 5) {
                        ThemeUtils.pageStarted(PeekViewFB.this, view);
                        ThemeUtils.facebookTheme(PeekViewFB.this, view);
                    }
                    if (themePusher == 10) {
                        ThemeUtils.pageStarted(PeekViewFB.this, view);
                        ThemeUtils.facebookTheme(PeekViewFB.this, view);
                    ...
                    if (url.contains("/photo.php?fbid=") ||url.contains("/photos/a.")) {
                        downloadImage.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Toast.makeText(getBaseContext(), R.string.getting_image, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (url.contains("/photo.php?fbid=") ||url.contains("/photos/a.")) {
                        ...
                        if (url.contains("sharer") || url.contains("/composer/") || url.contains("throwback_share_source")) {
                            ThemeUtils.showheader(PeekViewFB.this, webView);
                            swipeRefreshLayout.setEnabled(false);
                        } else {
                            ThemeUtils.removeheader(PeekViewFB.this, webView);
                        }
        ...
        webView.setWebChromeClient(new CustomChromeClient(this) {
            ...
            onReceivedTitle(WebView view, String title) {
                ...
                try {
                    PeekViewFB.this.setTitle(webView.getTitle().replace("", ""));
                    ...
                    if (icon != null && StaticUtils.isLollipop()) {
                        Palette.from(icon).generate(new Palette.PaletteAsyncListener() {
                            ...
                            public void onGenerated(Palette palette) {
                                ...
                                if (vibrant != null) {
                                    setColor(palette.getVibrantColor(ThemeUtils.getColorPrimary(PeekViewFB.this)));
                                } else {
                                    setColor(palette.getMutedColor(ThemeUtils.getColorPrimary(PeekViewFB.this)));
    ...
    protected void onResume() {
        ...
        ThemeUtils.pageStarted(PeekViewFB.this, webView);
        ThemeUtils.backgoundColorStyle(PeekViewFB.this, webView);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case ID_CONTEXT_MENU_COPY_IMAGE:
                ClipboardManager clipboard = (ClipboardManager) PeekViewFB.this.getSystemService(Context.CLIPBOARD_SERVICE);
        ...
        try {
            ...
            if(preferences.getBoolean("custom_pictures", false)){
                try{
                    ...
                    Toast.makeText(PeekViewFB.this, exc.toString(), Toast.LENGTH_LONG).show();
                }
            }else {
            ...
            if(isConnectedMobile) {
                Toast.makeText(PeekViewFB.this, getString(R.string.downloading_on_mobile), Toast.LENGTH_SHORT).show();
            }

        } catch (Exception exc) {
            Toast.makeText(PeekViewFB.this, exc.toString(), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void setColor(int color) {
        ...
        int colorFrom = ThemeUtils.getColorPrimary(PeekViewFB.this);
